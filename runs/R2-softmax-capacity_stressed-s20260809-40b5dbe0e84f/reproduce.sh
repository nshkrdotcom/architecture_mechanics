#!/usr/bin/env bash
# Regenerate R2-softmax-capacity_stressed-s20260809-40b5dbe0e84f from its own recorded identity.
#
...
RUN_ID="R2-softmax-capacity_stressed-s20260809-40b5dbe0e84f"
