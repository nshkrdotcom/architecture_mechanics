#!/usr/bin/env bash
# Regenerate R3-softmax-capacity_stressed-s20260809-ff1608b6388b from its own recorded identity.
#
...
RUN_ID="R3-softmax-capacity_stressed-s20260809-ff1608b6388b"
