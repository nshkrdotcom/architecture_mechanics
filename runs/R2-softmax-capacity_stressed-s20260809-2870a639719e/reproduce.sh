#!/usr/bin/env bash
# Regenerate R2-softmax-capacity_stressed-s20260809-2870a639719e from its own recorded identity.
#
...
RUN_ID="R2-softmax-capacity_stressed-s20260809-2870a639719e"
