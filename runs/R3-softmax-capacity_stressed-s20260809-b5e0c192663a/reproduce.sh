#!/usr/bin/env bash
# Regenerate R3-softmax-capacity_stressed-s20260809-b5e0c192663a from its own recorded identity.
#
...
RUN_ID="R3-softmax-capacity_stressed-s20260809-b5e0c192663a"
