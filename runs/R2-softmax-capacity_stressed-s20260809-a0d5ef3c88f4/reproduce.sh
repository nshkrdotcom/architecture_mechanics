#!/usr/bin/env bash
# Regenerate R2-softmax-capacity_stressed-s20260809-a0d5ef3c88f4 from its own recorded identity.
#
...
RUN_ID="R2-softmax-capacity_stressed-s20260809-a0d5ef3c88f4"
