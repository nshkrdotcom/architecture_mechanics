#!/usr/bin/env bash
# Regenerate R2-softmax-capacity_stressed-s20260809-8b4b9de2648f from its own recorded identity.
#
# Pins three things and re-runs:
#
#   source   git commit b806ea7e8295a0cb789508cffa85f3f7b9c648bd, exported with `git archive` — read-only, no
...
RUN_ID="R2-softmax-capacity_stressed-s20260809-8b4b9de2648f"
COMMIT="b806ea7e8295a0cb789508cffa85f3f7b9c648bd"
...
SOURCE_TREE_HASH="95167390da3d11f6f11e37c751d164ce174e2657633e9519ab3bdedb0801564b"
