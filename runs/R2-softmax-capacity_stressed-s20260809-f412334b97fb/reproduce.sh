#!/usr/bin/env bash
# Regenerate R2-softmax-capacity_stressed-s20260809-f412334b97fb from its own recorded identity.
#
...
RUN_ID="R2-softmax-capacity_stressed-s20260809-f412334b97fb"
