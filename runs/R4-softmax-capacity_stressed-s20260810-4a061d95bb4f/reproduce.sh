#!/usr/bin/env bash
# Regenerate R4-softmax-capacity_stressed-s20260810-4a061d95bb4f from its own recorded identity.
#
...
RUN_ID="R4-softmax-capacity_stressed-s20260810-4a061d95bb4f"
