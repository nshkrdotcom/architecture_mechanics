#!/usr/bin/env bash
# Regenerate R3-softmax-capacity_stressed-s20260809-25c71e37a74b from its own recorded identity.
#
...
RUN_ID="R3-softmax-capacity_stressed-s20260809-25c71e37a74b"
