#!/usr/bin/env bash
# Regenerate R4-softmax-capacity_stressed-s20260816-8a23bd9168e4 from its own recorded identity.
#
...
#            reproduce;
#   seed     20260816, which is inside that config.
#
...
RUN_ID="R4-softmax-capacity_stressed-s20260816-8a23bd9168e4"
