#!/usr/bin/env bash
# Regenerate R3-softmax-capacity_stressed-s20260809-d3bf0f482190 from its own recorded identity.
#
...
RUN_ID="R3-softmax-capacity_stressed-s20260809-d3bf0f482190"
