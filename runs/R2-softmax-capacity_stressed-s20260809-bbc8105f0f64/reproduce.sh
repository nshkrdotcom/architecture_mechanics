#!/usr/bin/env bash
# Regenerate R2-softmax-capacity_stressed-s20260809-bbc8105f0f64 from its own recorded identity.
#
...
RUN_ID="R2-softmax-capacity_stressed-s20260809-bbc8105f0f64"
