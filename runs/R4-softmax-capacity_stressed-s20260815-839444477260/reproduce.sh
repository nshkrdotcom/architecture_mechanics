#!/usr/bin/env bash
# Regenerate R4-softmax-capacity_stressed-s20260815-839444477260 from its own recorded identity.
#
...
#            reproduce;
#   seed     20260815, which is inside that config.
#
...
RUN_ID="R4-softmax-capacity_stressed-s20260815-839444477260"
