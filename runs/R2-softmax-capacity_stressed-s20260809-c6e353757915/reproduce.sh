#!/usr/bin/env bash
# Regenerate R2-softmax-capacity_stressed-s20260809-c6e353757915 from its own recorded identity.
#
# Pins three things and re-runs:
#
#   source   git commit b00fd3b5d011c342dd3973a2152b93de1a48b771, exported with `git archive` — read-only, no
...
RUN_ID="R2-softmax-capacity_stressed-s20260809-c6e353757915"
COMMIT="b00fd3b5d011c342dd3973a2152b93de1a48b771"
...
SOURCE_TREE_HASH="c9c3bdb6184d45152591aa20fcfa529bd1d4559556be3dfc4df24f091351ba0e"
