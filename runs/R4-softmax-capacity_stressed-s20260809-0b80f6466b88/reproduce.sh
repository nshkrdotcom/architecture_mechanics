#!/usr/bin/env bash
# Regenerate R4-softmax-capacity_stressed-s20260809-0b80f6466b88 from its own recorded identity.
#
...
RUN_ID="R4-softmax-capacity_stressed-s20260809-0b80f6466b88"
