#!/usr/bin/env bash
# Regenerate R3-softmax-capacity_stressed-s20260809-36b61e48e8f7 from its own recorded identity.
#
...
RUN_ID="R3-softmax-capacity_stressed-s20260809-36b61e48e8f7"
