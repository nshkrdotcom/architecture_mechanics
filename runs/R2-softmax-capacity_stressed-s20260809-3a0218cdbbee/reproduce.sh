#!/usr/bin/env bash
# Regenerate R2-softmax-capacity_stressed-s20260809-3a0218cdbbee from its own recorded identity.
#
...
RUN_ID="R2-softmax-capacity_stressed-s20260809-3a0218cdbbee"
