#!/usr/bin/env bash
# Regenerate R2-softmax-capacity_stressed-s20260809-88f219c2c8e7 from its own recorded identity.
#
# Pins three things and re-runs:
#
#   source   git commit 70e336acad8029ca119a8058cd9e2f779c55e6c6, exported with `git archive` — read-only, no
...
RUN_ID="R2-softmax-capacity_stressed-s20260809-88f219c2c8e7"
COMMIT="70e336acad8029ca119a8058cd9e2f779c55e6c6"
LAB="${AM_LAB_DIR:-/home/home/p/g/n/architecture_mechanics}"
CLAIM="claims/phase-map-a0-a1-sparsity-bottleneck.yml"
PRIMARY_METRIC="associative_recall_accuracy"
LOCK_HASH="6e018e7cf306742270ee2ff7a986657860cf18e656e14f1bcf7f28797abfb81e"
SOURCE_TREE_HASH="583ce367d7b09ad500c59288d32586305d886abe25381de99d255e459bde4748"
