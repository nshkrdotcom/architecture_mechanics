#!/usr/bin/env bash
# Regenerate R2-softmax-capacity_stressed-s20260809-cf8a273979a1 from its own recorded identity.
#
...
RUN_ID="R2-softmax-capacity_stressed-s20260809-cf8a273979a1"
