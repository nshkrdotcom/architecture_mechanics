#!/usr/bin/env bash
# Regenerate R2-softmax-capacity_stressed-s20260809-416cb41a2860 from its own recorded identity.
#
# Pins three things and re-runs:
#
#   source   git commit 7563f141f8a9b2c3e3edea43c939380abbe40bb7, exported with `git archive` — read-only, no
...
RUN_ID="R2-softmax-capacity_stressed-s20260809-416cb41a2860"
COMMIT="7563f141f8a9b2c3e3edea43c939380abbe40bb7"
...
SOURCE_TREE_HASH="0c2951531ca50a6c29aa9a9343872db7c7875d09579fa0ee7e856c0f1675f4c8"
