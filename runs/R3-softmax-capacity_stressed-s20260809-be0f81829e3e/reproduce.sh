#!/usr/bin/env bash
# Regenerate R3-softmax-capacity_stressed-s20260809-be0f81829e3e from its own recorded identity.
#
...
RUN_ID="R3-softmax-capacity_stressed-s20260809-be0f81829e3e"
