#!/usr/bin/env bash
# Regenerate R2-softmax-capacity_stressed-s20260809-17cb3e5b3edf from its own recorded identity.
#
...
RUN_ID="R2-softmax-capacity_stressed-s20260809-17cb3e5b3edf"
