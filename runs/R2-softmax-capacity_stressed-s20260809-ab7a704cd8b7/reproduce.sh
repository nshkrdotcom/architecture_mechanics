#!/usr/bin/env bash
# Regenerate R2-softmax-capacity_stressed-s20260809-ab7a704cd8b7 from its own recorded identity.
#
# Pins three things and re-runs:
#
#   source   git commit 43f53de06959db1a422ebdcd777359982197fd5e, exported with `git archive` — read-only, no
...
RUN_ID="R2-softmax-capacity_stressed-s20260809-ab7a704cd8b7"
COMMIT="43f53de06959db1a422ebdcd777359982197fd5e"
...
SOURCE_TREE_HASH="2bf8f3406b6e06ef8c0891dc82007b17006548658377eba5dea0500026e8d97c"
