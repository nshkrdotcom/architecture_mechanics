#!/usr/bin/env bash
# Regenerate R2-softmax-capacity_stressed-s20260809-0b166c31b0be from its own recorded identity.
#
...
RUN_ID="R2-softmax-capacity_stressed-s20260809-0b166c31b0be"
