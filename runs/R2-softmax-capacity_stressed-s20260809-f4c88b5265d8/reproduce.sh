#!/usr/bin/env bash
# Regenerate R2-softmax-capacity_stressed-s20260809-f4c88b5265d8 from its own recorded identity.
#
...
RUN_ID="R2-softmax-capacity_stressed-s20260809-f4c88b5265d8"
