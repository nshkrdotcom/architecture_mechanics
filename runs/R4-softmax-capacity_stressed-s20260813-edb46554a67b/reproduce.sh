#!/usr/bin/env bash
# Regenerate R4-softmax-capacity_stressed-s20260813-edb46554a67b from its own recorded identity.
#
...
#            reproduce;
#   seed     20260813, which is inside that config.
#
...
RUN_ID="R4-softmax-capacity_stressed-s20260813-edb46554a67b"
