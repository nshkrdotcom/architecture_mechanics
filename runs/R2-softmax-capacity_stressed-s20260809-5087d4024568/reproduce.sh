#!/usr/bin/env bash
# Regenerate R2-softmax-capacity_stressed-s20260809-5087d4024568 from its own recorded identity.
#
...
RUN_ID="R2-softmax-capacity_stressed-s20260809-5087d4024568"
