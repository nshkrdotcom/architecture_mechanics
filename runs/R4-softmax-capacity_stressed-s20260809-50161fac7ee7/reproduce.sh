#!/usr/bin/env bash
# Regenerate R4-softmax-capacity_stressed-s20260809-50161fac7ee7 from its own recorded identity.
#
# Pins three things and re-runs:
#
#   source   git commit 7b701498dd54008b0e4f60ed06170c0b6922da5b, exported with `git archive` — read-only, no
...
RUN_ID="R4-softmax-capacity_stressed-s20260809-50161fac7ee7"
COMMIT="7b701498dd54008b0e4f60ed06170c0b6922da5b"
...
SOURCE_TREE_HASH="d06214654979bc1a76b606650af56eb9d8fe753e730e61d469bf878300102a2e"
