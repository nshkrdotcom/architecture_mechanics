#!/usr/bin/env bash
# Regenerate R1-softmax-positive_control-s20260810-6c99847fe291 from its own recorded identity.
#
# Pins three things and re-runs:
#
#   source   git commit c5f13d2fcc694445a6a5cfc6a406cf26703705ec, exported with `git archive` — read-only, no
...
#            reproduce;
#   seed     20260810, which is inside that config.
#
...
RUN_ID="R1-softmax-positive_control-s20260810-6c99847fe291"
COMMIT="c5f13d2fcc694445a6a5cfc6a406cf26703705ec"
...
SOURCE_TREE_HASH="99e9ebc271035ef93f744ed3321a97979012934033465a1f2e4e6ec9bfc4c38a"
