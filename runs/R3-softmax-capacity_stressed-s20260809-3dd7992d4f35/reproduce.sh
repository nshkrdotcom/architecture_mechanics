#!/usr/bin/env bash
# Regenerate R3-softmax-capacity_stressed-s20260809-3dd7992d4f35 from its own recorded identity.
#
...
RUN_ID="R3-softmax-capacity_stressed-s20260809-3dd7992d4f35"
