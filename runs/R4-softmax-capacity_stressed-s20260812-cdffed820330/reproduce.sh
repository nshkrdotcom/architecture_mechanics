#!/usr/bin/env bash
# Regenerate R4-softmax-capacity_stressed-s20260812-cdffed820330 from its own recorded identity.
#
...
RUN_ID="R4-softmax-capacity_stressed-s20260812-cdffed820330"
