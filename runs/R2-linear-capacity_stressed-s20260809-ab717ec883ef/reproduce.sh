#!/usr/bin/env bash
# Regenerate R2-linear-capacity_stressed-s20260809-ab717ec883ef from its own recorded identity.
#
# Pins three things and re-runs:
#
#   source   git commit 138a950714c132ab2d4577130c15b3129df47fbd, exported with `git archive` — read-only, no
...
RUN_ID="R2-linear-capacity_stressed-s20260809-ab717ec883ef"
COMMIT="138a950714c132ab2d4577130c15b3129df47fbd"
LAB="${AM_LAB_DIR:-/home/home/p/g/n/architecture_mechanics}"
CLAIM="claims/a1-linear-solves-positive-control.yml"
PRIMARY_METRIC="associative_recall_accuracy"
LOCK_HASH="6e018e7cf306742270ee2ff7a986657860cf18e656e14f1bcf7f28797abfb81e"
SOURCE_TREE_HASH="a70399b6471c857b86e14aa8a89755fb1f987d19f2bb3c783317ce39d881e4d7"
