#!/usr/bin/env bash
# Regenerate R4-softmax-capacity_stressed-s20260812-1b4160b9bac8 from its own recorded identity.
#
...
#            reproduce;
#   seed     20260812, which is inside that config.
#
...
RUN_ID="R4-softmax-capacity_stressed-s20260812-1b4160b9bac8"
