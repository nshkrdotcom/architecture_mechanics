#!/usr/bin/env bash
# Regenerate R4-softmax-capacity_stressed-s20260814-9ac55eed41ab from its own recorded identity.
#
...
#            reproduce;
#   seed     20260814, which is inside that config.
#
...
RUN_ID="R4-softmax-capacity_stressed-s20260814-9ac55eed41ab"
