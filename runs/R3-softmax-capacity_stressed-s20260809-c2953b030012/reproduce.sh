#!/usr/bin/env bash
# Regenerate R3-softmax-capacity_stressed-s20260809-c2953b030012 from its own recorded identity.
#
...
RUN_ID="R3-softmax-capacity_stressed-s20260809-c2953b030012"
