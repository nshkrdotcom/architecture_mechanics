#!/usr/bin/env bash
# Regenerate R2-softmax-capacity_stressed-s20260809-b998732b3cfc from its own recorded identity.
#
...
RUN_ID="R2-softmax-capacity_stressed-s20260809-b998732b3cfc"
