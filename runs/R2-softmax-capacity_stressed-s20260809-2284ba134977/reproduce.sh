#!/usr/bin/env bash
# Regenerate R2-softmax-capacity_stressed-s20260809-2284ba134977 from its own recorded identity.
#
...
RUN_ID="R2-softmax-capacity_stressed-s20260809-2284ba134977"
