#!/usr/bin/env bash
# Regenerate R3-softmax-capacity_stressed-s20260809-0a9ecac858d0 from its own recorded identity.
#
...
RUN_ID="R3-softmax-capacity_stressed-s20260809-0a9ecac858d0"
