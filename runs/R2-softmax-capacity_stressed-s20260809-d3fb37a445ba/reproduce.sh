#!/usr/bin/env bash
# Regenerate R2-softmax-capacity_stressed-s20260809-d3fb37a445ba from its own recorded identity.
#
...
RUN_ID="R2-softmax-capacity_stressed-s20260809-d3fb37a445ba"
