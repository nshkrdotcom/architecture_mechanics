#!/usr/bin/env bash
# Regenerate R2-softmax-capacity_stressed-s20260809-53e1ed4ce66c from its own recorded identity.
#
...
RUN_ID="R2-softmax-capacity_stressed-s20260809-53e1ed4ce66c"
